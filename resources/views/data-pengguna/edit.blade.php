      ...
      <form enctype="multipart/form-data">
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="role_id" id="edit_role_id" style="width: 100%">
          ...
          <div class="form-group" id="department_wrapper_edit">
            <label>Pilih Departemen</label>
            <select class="form-control" name="department_id" id="edit_department_id" style="width: 100%">
              <option value="">-</option>
