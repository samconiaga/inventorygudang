          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="p-3"
                ...
                <div id="barcodePreviewCreate" style="font-family:'Libre Barcode 39', cursive;font-size:60px;line-height:1;color:#000;"></div>
                <div id="barcodeHumanCreate" style="font-size:12px;letter-spacing:2px;color:#6b7280;font-weight:600;margin-top:8px;">
                  Menunggu input...
                </div>
              </div>
              <small class="text-muted d-block mt-2">
                Barcode optional. Kalau kosong, sistem auto-generate dari kode barang.
              </small>
            </div>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" name="stok_minimum" id="stok_minimum" min="0">
